...
from app.dtos.payment.payment_response import PaymentResponse, PaymentHistoryResponse
...
async def api_get_history(user: Annotated[ShowUserDocument, Depends(get_current_user)]) -> Sequence[PaymentHistoryResponse]:
    try:
