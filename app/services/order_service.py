...
from app.entities.collections.orders.order_document import OrderDocument,PreOrderDocument
...
async def pre_order(user: ShowUserDocument, pre_order_creation_request: PreOrderCreationRequest) -> PreOrderDocument | None:
